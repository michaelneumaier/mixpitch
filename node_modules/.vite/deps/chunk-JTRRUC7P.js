...
var _callbacks = _classPrivateFieldLooseKey2("callbacks");
var _publish = _classPrivateFieldLooseKey2("publish");
...
function generateFileID(file, instanceId) {
  let id5 = instanceId || "uppy";
  if (typeof file.name === "string") {
    id5 += `-${encodeFilename(file.name.toLowerCase())}`;
  }
  if (file.type !== void 0) {
    id5 += `-${file.type}`;
  }
  if (file.meta && typeof file.meta.relativePath === "string") {
    id5 += `-${encodeFilename(file.meta.relativePath.toLowerCase())}`;
  }
  if (file.data.size !== void 0) {
    id5 += `-${file.data.size}`;
  }
  if (file.data.lastModified !== void 0) {
    id5 += `-${file.data.lastModified}`;
  }
  return id5;
}
...
var Restricter = class {
  ...
  validateAggregateRestrictions(existingFiles, addingFiles) {
    ...
    if (maxTotalFileSize) {
      const totalFilesSize = [...existingFiles, ...addingFiles].reduce((total, f3) => {
        var _f$size;
        return total + ((_f$size = f3.size) != null ? _f$size : 0);
      }, 0);
...
// node_modules/@uppy/core/lib/Uppy.js
function _classPrivateFieldLooseBase3(e3, t3) {
  if (!{}.hasOwnProperty.call(e3, t3))
    throw new TypeError("attempted to use private field on non-instance");
  return e3;
}
var id3 = 0;
function _classPrivateFieldLooseKey3(e3) {
...
var _plugins = _classPrivateFieldLooseKey3("plugins");
var _restricter = _classPrivateFieldLooseKey3("restricter");
var _storeUnsubscribe = _classPrivateFieldLooseKey3("storeUnsubscribe");
var _emitter = _classPrivateFieldLooseKey3("emitter");
var _preProcessors = _classPrivateFieldLooseKey3("preProcessors");
var _uploaders = _classPrivateFieldLooseKey3("uploaders");
var _postProcessors = _classPrivateFieldLooseKey3("postProcessors");
var _informAndEmit = _classPrivateFieldLooseKey3("informAndEmit");
var _checkRequiredMetaFieldsOnFile = _classPrivateFieldLooseKey3("checkRequiredMetaFieldsOnFile");
var _checkRequiredMetaFields = _classPrivateFieldLooseKey3("checkRequiredMetaFields");
var _assertNewUploadAllowed = _classPrivateFieldLooseKey3("assertNewUploadAllowed");
var _transformFile = _classPrivateFieldLooseKey3("transformFile");
var _startIfAutoProceed = _classPrivateFieldLooseKey3("startIfAutoProceed");
var _checkAndUpdateFileState = _classPrivateFieldLooseKey3("checkAndUpdateFileState");
var _getFilesToRetry = _classPrivateFieldLooseKey3("getFilesToRetry");
var _doRetryAll = _classPrivateFieldLooseKey3("doRetryAll");
var _handleUploadProgress = _classPrivateFieldLooseKey3("handleUploadProgress");
var _updateTotalProgress = _classPrivateFieldLooseKey3("updateTotalProgress");
var _updateTotalProgressThrottled = _classPrivateFieldLooseKey3("updateTotalProgressThrottled");
var _calculateTotalProgress = _classPrivateFieldLooseKey3("calculateTotalProgress");
var _addListeners = _classPrivateFieldLooseKey3("addListeners");
var _updateOnlineStatus = _classPrivateFieldLooseKey3("updateOnlineStatus");
var _requestClientById = _classPrivateFieldLooseKey3("requestClientById");
var _createUpload = _classPrivateFieldLooseKey3("createUpload");
var _getUpload = _classPrivateFieldLooseKey3("getUpload");
var _removeUpload = _classPrivateFieldLooseKey3("removeUpload");
var _runUpload = _classPrivateFieldLooseKey3("runUpload");
var Uppy = class _Uppy {
  ...
  getFilesByIds(ids) {
    return ids.map((id5) => this.getFile(id5));
  }
...
Uppy plugins must have unique \`id\` options.`;
  ...
  getPlugin(id5) {
    for (const plugins of Object.values(_classPrivateFieldLooseBase3(this, _plugins)[_plugins])) {
      const foundPlugin = plugins.find((plugin) => plugin.id === id5);
      if (foundPlugin != null)
        return foundPlugin;
    }
    return void 0;
  ...
  registerRequestClient(id5, client) {
    _classPrivateFieldLooseBase3(this, _requestClientById)[_requestClientById].set(id5, client);
  }
  /** @protected */
...
function _transformFile2(fileDescriptorOrFile) {
  ...
  const id5 = getSafeFileId(file, this.getID());
...
function $() {
  for (var n2, u3, t3, r3, o2, f3, c3, s3 = 1; i.length; )
    i.length > s3 && i.sort(e), n2 = i.shift(), s3 = i.length, n2.__d && (t3 = void 0, o2 = (r3 = (u3 = n2).__v).__e, f3 = [], c3 = [], u3.__P && ((t3 = d({}, r3)).__v = r3.__v + 1, l.vnode && l.vnode(t3), O(u3.__P, t3, r3, u3.__n, u3.__P.namespaceURI, 32 & r3.__u ? [o2] : null, f3, null == o2 ? S(r3) : o2, !!(32 & r3.__u), c3), t3.__v = r3.__v, t3.__.__k[t3.__i] = t3, z(f3, t3, c3), t3.__e != o2 && C(t3)));
  $.__r = 0;
}
function I(n2, l3, u3, t3, i3, r3, o2, e3, f3, c3, s3) {
  ...
  for (f3 = P(u3, l3, _3, f3, m3), a3 = 0; a3 < m3; a3++)
    null != (y3 = u3.__k[a3]) && (h3 = -1 == y3.__i ? p : _3[y3.__i] || p, y3.__i = a3, g4 = O(n2, y3, h3, i3, r3, o2, e3, f3, c3, s3), w3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && q(h3.ref, null, y3), s3.push(y3.ref, y3.__c || w3, y3)), null == d3 && null != w3 && (d3 = w3), 4 & y3.__u || h3.__k === y3.__k ? f3 = A(y3, f3, n2) : "function" == typeof y3.type && void 0 !== g4 ? f3 = g4 : w3 && (f3 = w3.nextSibling), y3.__u &= -7);
  return u3.__e = d3, f3;
}
function P(n2, l3, u3, t3, i3) {
  var r3, o2, e3, f3, c3, s3 = u3.length, a3 = s3, h3 = 0;
  for (n2.__k = new Array(i3), r3 = 0; r3 < i3; r3++)
    null != (o2 = l3[r3]) && "boolean" != typeof o2 && "function" != typeof o2 ? (f3 = r3 + h3, (o2 = n2.__k[r3] = "string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? m(null, o2, null, null, null) : w(o2) ? m(k, { children: o2 }, null, null, null) : null == o2.constructor && o2.__b > 0 ? m(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : o2).__ = n2, o2.__b = n2.__b + 1, e3 = null, -1 != (c3 = o2.__i = L(o2, u3, f3, a3)) && (a3--, (e3 = u3[c3]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c3 && (i3 > s3 ? h3-- : i3 < s3 && h3++), "function" != typeof o2.type && (o2.__u |= 4)) : c3 != f3 && (c3 == f3 - 1 ? h3-- : c3 == f3 + 1 ? h3++ : (c3 > f3 ? h3-- : h3++, o2.__u |= 4))) : n2.__k[r3] = null;
  if (a3)
    for (r3 = 0; r3 < s3; r3++)
...
function L(n2, l3, u3, t3) {
  var i3, r3, o2 = n2.key, e3 = n2.type, f3 = l3[u3];
  if (null === f3 && null == n2.key || f3 && o2 == f3.key && e3 == f3.type && 0 == (2 & f3.__u))
    return u3;
  if (t3 > (null != f3 && 0 == (2 & f3.__u) ? 1 : 0))
    for (i3 = u3 - 1, r3 = u3 + 1; i3 >= 0 || r3 < l3.length; ) {
      if (i3 >= 0) {
        if ((f3 = l3[i3]) && 0 == (2 & f3.__u) && o2 == f3.key && e3 == f3.type)
          return i3;
        i3--;
      }
      if (r3 < l3.length) {
        if ((f3 = l3[r3]) && 0 == (2 & f3.__u) && o2 == f3.key && e3 == f3.type)
          return r3;
        r3++;
      }
    }
...
function O(n2, u3, t3, i3, r3, o2, e3, f3, c3, s3) {
  var a3, h3, p2, v3, y3, _3, m3, b2, S2, C2, M2, $2, P4, A4, H3, L2, T4, j4 = u3.type;
  ...
  n:
    if ("function" == typeof j4)
      try {
        if (b2 = u3.props, S2 = "prototype" in j4 && j4.prototype.render, C2 = (a3 = j4.contextType) && i3[a3.__c], M2 = a3 ? C2 ? C2.props.value : a3.__ : i3, t3.__c ? m3 = (h3 = u3.__c = t3.__c).__ = h3.__E : (S2 ? u3.__c = h3 = new j4(b2, M2) : (u3.__c = h3 = new x(b2, M2), h3.constructor = j4, h3.render = D), C2 && C2.sub(h3), h3.props = b2, h3.state || (h3.state = {}), h3.context = M2, h3.__n = i3, p2 = h3.__d = true, h3.__h = [], h3._sb = []), S2 && null == h3.__s && (h3.__s = h3.state), S2 && null != j4.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, j4.getDerivedStateFromProps(b2, h3.__s))), v3 = h3.props, y3 = h3.state, h3.__v = u3, p2)
        ...
        h3.state = h3.__s, null != h3.getChildContext && (i3 = d(d({}, i3), h3.getChildContext())), S2 && !p2 && null != h3.getSnapshotBeforeUpdate && (_3 = h3.getSnapshotBeforeUpdate(v3, y3)), L2 = a3, null != a3 && a3.type === k && null == a3.key && (L2 = N(a3.props.children)), f3 = I(n2, w(L2) ? L2 : [L2], u3, t3, i3, r3, o2, e3, f3, c3, s3), h3.base = u3.__e, u3.__u &= -161, h3.__h.length && e3.push(h3), m3 && (h3.__E = h3.__ = null);
      } catch (n3) {
      ...
      null == o2 && u3.__v == t3.__v ? (u3.__k = t3.__k, u3.__e = t3.__e) : f3 = u3.__e = V(t3.__e, u3, t3, i3, r3, o2, e3, c3, s3);
...
function V(u3, t3, i3, r3, o2, e3, f3, c3, s3) {
  ...
  if (null == u3) {
    ...
    u3 = document.createElementNS(o2, x3, k3.is && k3), c3 && (l.__m && l.__m(t3, e3), c3 = false), e3 = null;
  }
  if (null == x3)
    b2 === k3 || c3 && u3.data == k3 || (u3.data = k3);
  else {
    if (e3 = e3 && n.call(u3.childNodes), b2 = i3.props || p, !c3 && null != e3)
    ...
    for (a3 in k3)
      d3 = k3[a3], "children" == a3 ? y3 = d3 : "dangerouslySetInnerHTML" == a3 ? h3 = d3 : "value" == a3 ? _3 = d3 : "checked" == a3 ? m3 = d3 : c3 && "function" != typeof d3 || b2[a3] === d3 || j(u3, a3, d3, b2[a3], o2);
    if (h3)
      c3 || v3 && (h3.__html == v3.__html || h3.__html == u3.innerHTML) || (u3.innerHTML = h3.__html), t3.__k = [];
    else if (v3 && (u3.innerHTML = ""), I("template" == t3.type ? u3.content : u3, w(y3) ? y3 : [y3], t3, i3, r3, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e3, f3, e3 ? e3[0] : i3.__k && S(i3, 0), c3, s3), null != e3)
      for (a3 = e3.length; a3--; )
        g(e3[a3]);
    c3 || (a3 = "value", "progress" == x3 && null == _3 ? u3.removeAttribute("value") : null != _3 && (_3 !== u3[a3] || "progress" == x3 && !_3 || "option" == x3 && _3 != b2[a3]) && j(u3, a3, _3, b2[a3], o2), a3 = "checked", null != m3 && m3 != u3[a3] && j(u3, a3, m3, b2[a3], o2));
  }
  return u3;
}
function q(n2, u3, t3) {
...
function E(u3, t3, i3) {
  var r3, o2, e3, f3;
  t3 == document && (t3 = document.documentElement), l.__ && l.__(u3, t3), o2 = (r3 = "function" == typeof i3) ? null : i3 && i3.__k || t3.__k, e3 = [], f3 = [], O(t3, u3 = (!r3 && i3 || t3).__k = _(k, null, [u3]), o2 || p, p, t3.namespaceURI, !r3 && i3 ? [i3] : o2 ? null : t3.firstChild ? n.call(t3.childNodes) : null, e3, !r3 && i3 ? i3 : o2 ? o2.__e : t3.firstChild, r3, f3), z(e3, u3, f3);
}
...
l.unmount = function(n2) {
  ...
  var u3 = j3(r3.__v), o2 = false, i3 = function() {
...
function _classPrivateFieldLooseBase4(e3, t3) {
  if (!{}.hasOwnProperty.call(e3, t3))
    throw new TypeError("attempted to use private field on non-instance");
  return e3;
}
var id4 = 0;
function _classPrivateFieldLooseKey4(e3) {
  return "__private_" + id4++ + "_" + e3;
}
...
var _updateUI = _classPrivateFieldLooseKey4("updateUI");
...
@uppy/utils/lib/Translator.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JTRRUC7P.js.map
