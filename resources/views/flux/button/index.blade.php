...
$classes = Flux::classes()
    ...
    ->add('transition-[background-color,border-color,box-shadow,opacity] duration-200 ease-in-out')
    ...
    ->add(match ($variant) { // Background color...
        ...
        'filled' => 'bg-gradient-to-r from-slate-100 to-slate-200 hover:from-slate-200 hover:to-slate-300 dark:from-slate-700 dark:to-slate-800 dark:hover:from-slate-600 dark:hover:to-slate-700',
        'outline' => 'bg-white hover:bg-slate-50 dark:bg-slate-800 dark:hover:bg-slate-700',
        ...
        'subtle' => 'bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800/50',
    })
    ->add(match ($variant) { // Text color...
        'primary' => 'text-white font-semibold',
        'filled' => 'text-slate-700 dark:text-slate-200 font-medium',
        'outline' => 'text-slate-700 dark:text-slate-200',
        'danger' => 'text-white font-semibold',
        'ghost' => 'text-slate-700 dark:text-slate-200',
        'subtle' => 'text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200',
    })
