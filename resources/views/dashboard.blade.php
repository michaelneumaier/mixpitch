...
<div class="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-screen">
    <div class="mx-auto px-2 md:py-2">
        <div class="mx-auto">
            ...
            <!-- Work Section -->
            <div class="relative mb-2">
                <flux:card class="p-4 lg:p-6 xl:p-8" x-data="{ filter: 'all' }">
                    <!-- Section Header -->
                                    ...
                                    <!-- Filter Dropdown -->
                                            <div>
                                                <flux:dropdown position="bottom" align="start">
                                                    ...
                                                    <flux:menu>
                                                        <flux:menu.item @click="filter = 'all'" icon="squares-2x2" 
                                                                        x-bind:class="filter === 'all' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/20 dark:text-indigo-300' : ''">
                                                            All
                                                        </flux:menu.item>
                                                        <flux:menu.item @click="filter = 'project'" icon="folder"
                                                                        x-bind:class="filter === 'project' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/20 dark:text-indigo-300' : ''">
                                                            Projects
                                                        </flux:menu.item>
                                                        <flux:menu.item @click="filter = 'contest'" icon="trophy"
                                                                        x-bind:class="filter === 'contest' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/20 dark:text-indigo-300' : ''">
                                                            Contests
                                                        </flux:menu.item>
                                                        <flux:menu.item @click="filter = 'client'" icon="briefcase"
                                                                        x-bind:class="filter === 'client' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/20 dark:text-indigo-300' : ''">
                                                            Client Projects
                                                        </flux:menu.item>
                                                        <flux:menu.item @click="filter = 'pitch'" icon="paper-airplane"
                                                                        x-bind:class="filter === 'pitch' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/20 dark:text-indigo-300' : ''">
                                                            Pitches
                                                        </flux:menu.item>
                                                    </flux:menu>
                                                </flux:dropdown>
