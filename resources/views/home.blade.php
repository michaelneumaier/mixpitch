...
@section('content')
    <div class="container-home">
        <div class="py-2 md:px-20">
            <h1 class="text-6xl md:text-7xl text-white text-center">Empower&nbsp;Musicians. Elevate&nbsp;Mixers. Unleash&nbsp;Creativity.</h1>
    ...
    {{--        <div class="py-5">--}}
    {{--            <h1 class="display-2 text-white align-items-center text-center">Empower&nbsp;Musicians. Elevate&nbsp;Mixers.--}}
    ...
    {{--                    @auth--}}
    {{--                        <a href="{{ route('login') }}"--}}
    {{--                           class="browse-btn">Browse Projects</a>--}}
    {{--                        <!-- Adjust the route as needed -->--}}
    {{--                    @else--}}
    {{--                        <a href="{{ route('login') }}"--}}
    {{--                           class="browse-btn">Browse Projects</a>--}}
