                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                    <div class="flex-1">
                        ...
                        <flux:subheading class="text-gray-600 dark:text-gray-400">
                            <span class="lg:hidden">Analytics and insights for your client relationships</span>
                            <span class="hidden lg:inline">Comprehensive analytics and insights for your client relationships</span>
                        </flux:subheading>
                    </div>
                    ...
                    <div class="flex-shrink-0">
                        <flux:button 
                            ...
                            <span class="hidden lg:inline">New Client Project</span>
                        </flux:button>
                    </div>
                </div>
