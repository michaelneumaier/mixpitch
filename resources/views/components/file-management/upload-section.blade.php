...
<div class="bg-white rounded-lg border border-base-300 shadow-sm overflow-hidden mb-6" x-data="{ showGoogleDriveModal: false }">
    <div class="p-4 border-b border-base-200 bg-base-100/50">
        <div class="flex items-center justify-between">
            ...
            <flux:button 
                variant="outline" 
                size="sm"
                @click="showGoogleDriveModal = true"
    ...
    <div x-show="showGoogleDriveModal" @close-modal.window="showGoogleDriveModal = false">
