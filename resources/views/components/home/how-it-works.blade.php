<!-- Next-Level How It Works Section -->
    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="max-w-4xl mx-auto">
            <div class="relative space-y-8">
                ...
                <div class="absolute left-1/2 top-12 bottom-12 w-1 bg-gradient-to-b from-purple-400 via-blue-500 to-purple-600 opacity-20 -translate-x-1/2 hidden md:block"></div>

                <!-- Step 1: Set Up Project -->
                <div class="relative group animate-fade-in-up" style="animation-delay: 0.2s;">
                    <div class="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 md:p-8 group-hover:bg-white/15 transition-transform duration-300 hover:shadow-2xl hover:-translate-y-1">
