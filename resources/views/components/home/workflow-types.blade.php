    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16 animate-fade-in-up">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                From professional client management to open marketplace projects, choose the workflow that fits your needs.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="group relative animate-fade-in-up" style="animation-delay: 0.1s;">
                ...
                <div class="relative h-full bg-white/90 rounded-2xl p-6 shadow-xl border border-gray-100 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="bg-purple-100 text-purple-700 px-2 py-1 rounded-full text-xs font-medium">
                            Most Popular
                        </div>
                    </div>
                    ...
                    <p class="text-gray-600 text-sm mb-4 leading-relaxed">
                        Professional client service workflow with revision policies, milestone payments, branded portals, and version control. Ideal for studios, mixing engineers, mastering facilities, and podcast producers.
                    </p>
                    ...
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-center">
                            ...
                            Revision policies with auto-billing
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        ...
                        <li class="flex items-center">
                            ...
                            Branded client portals (no signup)
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="group relative animate-fade-in-up" style="animation-delay: 0.2s;">
                ...
                <div class="relative h-full bg-white/90 rounded-2xl p-6 shadow-xl border border-gray-100 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <!-- Title -->
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Standard Project</h3>

                    <!-- Description -->
                    <p class="text-gray-600 text-sm mb-4 leading-relaxed">
                        Post projects and receive pitches from producers. Multiple submissions, approval workflow, milestone payments, and escrow protection.
                    </p>
                    ...
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-center">
                            ...
                            Multiple pitches from producers
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
            ...
            <div class="group relative animate-fade-in-up" style="animation-delay: 0.3s;">
                ...
                <div class="relative h-full bg-white/90 rounded-2xl p-6 shadow-xl border border-gray-100 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <!-- Title -->
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Contest</h3>

                    <!-- Description -->
                    <p class="text-gray-600 text-sm mb-4 leading-relaxed">
                        Host competitions with deadline management, prize distribution, and judging tools. Perfect for beat battles and remix competitions.
                    </p>
        ...
        <div class="text-center mt-16 animate-fade-in-up">
            <p class="text-gray-600 mb-6 text-lg">
                Ready to get started with the perfect workflow for your projects and clients?
            </p>
            <div class="flex flex-col md:flex-row items-stretch md:items-center text-center justify-center gap-4 md:gap-6">
                @auth
                <a href="{{ route('projects.create') }}" 
                   class="text-center w-full md:w-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 px-8 rounded-xl transition-transform duration-300 transform hover:scale-105 hover:shadow-xl text-center">
