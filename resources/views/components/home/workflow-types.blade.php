    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16 animate-fade-in-up">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                From open marketplace projects to professional client management, choose the workflow that perfectly fits your needs and working style.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div class="group relative animate-fade-in-up" style="animation-delay: 0.1s;">
                ...
                <div class="relative bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <p class="text-gray-600 text-sm mb-4 leading-relaxed">
                        Open marketplace where multiple producers can pitch ideas for your project. Perfect for discovering new talent and fresh perspectives.
                    </p>
            ...
            <div class="group relative animate-fade-in-up" style="animation-delay: 0.2s;">
                ...
                <div class="relative bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <!-- Title -->
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Contest Project</h3>
                    
                    <!-- Description -->
                    <p class="text-gray-600 text-sm mb-4 leading-relaxed">
                        Run competitions with prizes and deadlines. Create excitement and attract top talent with structured submission periods and judging.
                    </p>
            ...
            <div class="group relative animate-fade-in-up" style="animation-delay: 0.3s;">
                ...
                <div class="relative bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <!-- Title -->
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Direct Hire</h3>
                    
                    <!-- Description -->
                    <p class="text-gray-600 text-sm mb-4 leading-relaxed">
                        Work directly with a specific producer you already know and trust. Perfect for ongoing relationships and follow-up projects.
                    </p>
            ...
            <div class="group relative animate-fade-in-up" style="animation-delay: 0.4s;">
                ...
                <div class="relative bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <!-- Description -->
                    <p class="text-gray-600 text-sm mb-4 leading-relaxed">
                        Manage your existing clients with professional tools. Secure portals, integrated payments, and streamlined workflows designed for engineers and studios.
                    </p>
