...
<div class="py-20 bg-gradient-to-b from-white via-gray-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16 animate-fade-in-up">
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 text-blue-700 text-sm font-medium mb-6">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Whether you're just starting out or running a studio, choose the path that fits your goals and experience level.
            </p>
        </div>
                ...
                <div class="relative bg-white rounded-2xl p-8 shadow-xl border border-gray-100 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <div class="space-y-4 mb-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 mb-1">Browse Open Projects</h4>
                                <p class="text-gray-600 text-sm">Find projects that match your interest and skill level</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 mb-1">Submit Your Best Work</h4>
                                <p class="text-gray-600 text-sm">Create a mix or master and showcase your interpretation</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 mb-1">Get Real Feedback & Earn</h4>
                                <p class="text-gray-600 text-sm">Learn from artists and get paid when you're selected</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t pt-4">
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 bg-green-50 text-green-700 rounded-full text-xs font-medium">Real Experience</span>
                            <span class="px-3 py-1 bg-green-50 text-green-700 rounded-full text-xs font-medium">Portfolio Building</span>
                            <span class="px-3 py-1 bg-green-50 text-green-700 rounded-full text-xs font-medium">No Risk</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative bg-white rounded-2xl p-8 shadow-xl border border-gray-100 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <div class="space-y-4 mb-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 mb-1">Upload Your Track</h4>
                                <p class="text-gray-600 text-sm">Share your project with details and budget</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 mb-1">Receive Multiple Mixes</h4>
                                <p class="text-gray-600 text-sm">Audio professionals compete to give you their best work</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 mb-1">Choose & Pay</h4>
                                <p class="text-gray-600 text-sm">Select the mix that captures your vision perfectly</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t pt-4">
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-xs font-medium">Multiple Options</span>
                            <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-xs font-medium">Pay Only If Happy</span>
                            <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-xs font-medium">Global Talent</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative bg-white rounded-2xl p-8 shadow-xl border border-gray-100 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <div class="space-y-4 mb-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 mb-1">Set Up Client Projects</h4>
                                <p class="text-gray-600 text-sm">Create secure portals for your existing clients</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 mb-1">Collaborate Professionally</h4>
                                <p class="text-gray-600 text-sm">File management, feedback, and approval workflows</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 mb-1">Get Paid Seamlessly</h4>
                                <p class="text-gray-600 text-sm">Integrated payment processing and invoicing</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mt-16 text-center">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                ...
                <div class="group relative">
                    ...
                    <div class="relative bg-white rounded-xl p-6 shadow-lg border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
        ...
        <div class="text-center mt-16 animate-fade-in-up">
            ...
            <div class="inline-flex items-center justify-center space-x-6">
                ...
                <a href="{{ route('projects.create') }}" 
                   class="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                ...
                <a href="{{ route('projects.index') }}" 
                   class="bg-white border-2 border-gray-200 hover:border-gray-300 text-gray-700 hover:text-gray-900 font-semibold py-3 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                    Browse Projects
                </a>
            </div>
        </div>
