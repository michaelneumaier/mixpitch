    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="relative h-full bg-white/90 rounded-2xl p-8 shadow-xl border border-gray-100 transition-shadow duration-300 hover:shadow-2xl">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            ...
                            <span class="text-gray-600 text-sm">Revision tracking prevents scope creep across all projects</span>
                        </div>
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="text-gray-600 text-sm">Automated billing for extra revision rounds</span>
                        </div>
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="text-gray-600 text-sm">Sequential milestone payments for predictable cash flow</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative h-full bg-white/90 rounded-2xl p-8 shadow-xl border border-gray-100 transition-shadow duration-300 hover:shadow-2xl">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            ...
                            <span class="text-gray-600 text-sm">Bulk version upload with intelligent name-matching</span>
                        </div>
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="text-gray-600 text-sm">Individual file approval tracking per track</span>
                        </div>
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="text-gray-600 text-sm">Branded client portal with mobile-friendly playback</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative h-full bg-white/90 rounded-2xl p-8 shadow-xl border border-gray-100 transition-shadow duration-300 hover:shadow-2xl">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            ...
                            <span class="text-gray-600 text-sm">Consistent revision policies across all episodes</span>
                        </div>
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="text-gray-600 text-sm">Episode-by-episode milestone structure for regular income</span>
                        </div>
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="text-gray-600 text-sm">Time-stamped client feedback for efficient edits</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative h-full bg-white/90 rounded-2xl p-8 shadow-xl border border-gray-100 transition-shadow duration-300 hover:shadow-2xl">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            ...
                            <span class="text-gray-600 text-sm">Time-stamped feedback eliminates miscommunication</span>
                        </div>
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="text-gray-600 text-sm">Complete version history with snapshots</span>
                        </div>
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="text-gray-600 text-sm">Watermark protection until final payment</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mt-16 animate-fade-in-up">
            <p class="text-gray-600 mb-6 text-lg">
                Ready to streamline your client workflow like these professionals?
            </p>
