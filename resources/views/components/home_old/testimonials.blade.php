    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-16 animate-fade-in-up">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Hear from the creative minds who have experienced the transformative power of global musical collaboration.
            </p>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="group relative animate-fade-in-up" style="animation-delay: 0.2s;">
                ...
                <div class="relative bg-white rounded-2xl p-8 shadow-xl border border-gray-100 transform transition-[transform,colors,shadow] duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <blockquote class="text-lg text-gray-700 leading-relaxed mb-8">
                        "MixPitch completely transformed my approach to music production. I received multiple creative interpretations of my track from talented professionals worldwide, and found the perfect mixing engineer who truly understood my artistic vision."
                    </blockquote>

                    <!-- Author -->
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
                            AR
                        </div>
                        <div class="ml-4">
                            <h4 class="font-semibold text-gray-900 text-lg">Alex Rodriguez</h4>
                            <p class="text-gray-600">Indie Artist • Los Angeles</p>
                            <div class="flex items-center mt-1">
                                ...
                                <span class="text-sm text-blue-600 font-medium">Artist</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="group relative animate-fade-in-up" style="animation-delay: 0.4s;">
                ...
                <div class="relative bg-white rounded-2xl p-8 shadow-xl border border-gray-100 transform transition-[transform,colors,shadow] duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <!-- Testimonial Text -->
                    <blockquote class="text-lg text-gray-700 leading-relaxed mb-8">
                        "As a mixing engineer, MixPitch has opened doors to incredible opportunities. I've worked with diverse artists, expanded my portfolio, and built lasting professional relationships. The platform truly values quality work."
                    </blockquote>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h4 class="font-semibold text-gray-900 text-lg">Jamie Lee</h4>
                            <p class="text-gray-600">Mixing Engineer • London</p>
                            <div class="flex items-center mt-1">
                                ...
                                <span class="text-sm text-purple-600 font-medium">Audio Professional</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="group relative animate-fade-in-up" style="animation-delay: 0.6s;">
                ...
                <div class="relative bg-white rounded-2xl p-8 shadow-xl border border-gray-100 transform transition-[transform,colors,shadow] duration-300 hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <!-- Testimonial Text -->
                    <blockquote class="text-lg text-gray-700 leading-relaxed mb-8">
                        "The collaborative environment on MixPitch is unparalleled. I've connected with talented artists from every corner of the globe, and it's become an essential part of my creative workflow. Absolutely game-changing."
                    </blockquote>

                    <!-- Author -->
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gradient-to-r from-indigo-500 to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
                            TM
                        </div>
                        <div class="ml-4">
                            <h4 class="font-semibold text-gray-900 text-lg">Taylor Morgan</h4>
                            <p class="text-gray-600">Music Producer • Nashville</p>
                            <div class="flex items-center mt-1">
                                ...
                                <span class="text-sm text-indigo-600 font-medium">Producer</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="text-center mt-16 animate-fade-in-up" style="animation-delay: 0.8s;">
            <div class="inline-flex items-center justify-center space-x-6">
                ...
                <a href="#" class="group relative overflow-hidden bg-white border-2 border-gray-200 hover:border-gray-300 text-gray-700 hover:text-gray-900 font-semibold py-3 px-8 rounded-xl transition-[transform,colors,shadow] duration-300 transform hover:scale-105 hover:shadow-lg">
                    <span class="relative flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        </svg>
