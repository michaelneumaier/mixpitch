...
<div class="overflow-hidden rounded-2xl border border-green-200/50 bg-gradient-to-br from-white/90 to-green-50/90 shadow-lg backdrop-blur-sm">
    <div class="border-b border-green-200/50 bg-gradient-to-r from-green-100/80 to-emerald-100/80 p-4 backdrop-blur-sm">
        <div class="flex items-center">
            ...
            <div>
                <h5 class="font-bold text-green-800">Upload Your Work
                    <span class="ml-2 bg-green-200 text-green-800 text-xs px-2 py-1 rounded-full">
                        {{ $fileCount }} files
                    </span>
                </h5>
                <p class="text-xs text-green-600">Upload your deliverables as you create them</p>
            </div>
        </div>
    </div>
