...
<div class="overflow-hidden rounded-2xl border border-blue-200/50 bg-gradient-to-br from-white/90 to-blue-50/90 shadow-lg backdrop-blur-sm">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-blue-600">Download these first to understand project requirements</p>
                </div>
            </div>
        </div>
    </div>
