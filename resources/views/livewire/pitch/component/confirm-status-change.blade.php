            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-lg w-full mx-4 md:mx-0 z-10 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    @if ($pendingAction === 'deny')
                        <div class="mb-4">
                            <label for="denyReason" class="block text-sm font-medium text-gray-700 mb-1">Reason for denial</label>
                            <textarea
                                id="denyReason"
                                wire:model.defer="actionData.reason"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                                rows="3"
                                placeholder="Please explain why you are denying this pitch..."
                            ></textarea>
                        </div>
                    @endif
                    ...
                    @if ($pendingAction === 'requestChanges')
                        <div class="mb-4">
                            <label for="changesRequested" class="block text-sm font-medium text-gray-700 mb-1">Requested Changes</label>
                            <textarea
                                id="changesRequested"
                                wire:model.defer="actionData.reason"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                                rows="3"
                                placeholder="Please specify what changes you'd like to see in this pitch..."
                            ></textarea>
                        </div>
                    @endif
                    ...
                    @if ($pendingAction === 'complete')
                        <div class="mb-4">
                            <label for="completionFeedback" class="block text-sm font-medium text-gray-700 mb-1">Completion Feedback (optional)</label>
                            <textarea
                                id="completionFeedback"
                                wire:model.defer="actionData.feedback"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                                rows="3"
                                placeholder="Add any feedback about the completed pitch..."
                            ></textarea>
                        </div>
                    @endif
                </div>
